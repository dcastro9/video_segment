...
public:
	...
	void construct(flowUV& UV, const cv::Mat& Du, const cv::Mat& Dv, const cv::Mat& Ix,
				   const cv::Mat& Iy, const cv::Mat It, const OpticalFlowParams& params);
...
private:
	...
	static void buildA (CRSSparseMat* const A,
						const int cols,
						const int rows,
